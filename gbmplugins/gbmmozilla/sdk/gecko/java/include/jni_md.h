...
#	include <windows.h>
#	if defined(_MSC_VER) || defined(__GNUC__) || defined(__WATCOMC__) || defined(__WATCOM_CPLUSPLUS__)
#		if defined(WIN32) || defined(_WIN32)
#			define JNI_PUBLIC_API(ResultType)	__declspec(dllexport) ResultType __stdcall
#			define JNI_PUBLIC_VAR(VarType)		VarType
