...
#else
    void *javaClass;    /* set to NULL; No JRI in OS/2 NAV 2.02 - 3.0 */
#endif
} NPPluginFuncs;
...
#else
    void *getJavaEnv;   /* set to NULL; No JRI in OS/2 NAV 2.02 - 3.0 */
    void *getJavaPeer;  /* set to NULL; No JRI in OS/2 NAV 2.02 - 3.0 */
#endif
