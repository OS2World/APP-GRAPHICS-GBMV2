...
CFLAGS         = $(CWARNS) -i.. -bt=os2 -zq -onatxh -oe=50 -sg -ei -6r -fp6 -fpi87 -bm -mf /DNDEBUG
CFLAGS_DBG     = $(CWARNS) -i.. -bt=os2 -zq -sg -ei -6r -fp6 -fpi87 -bm -mf -d2 /DDEBUG
LIBFLAGS       = -q -n -b -c
...
jpeg.lib: $(LIBOBJECTS)
           wlib $(LIBFLAGS) $@ +$(SYSDEPMEM) +jaricom.obj \
