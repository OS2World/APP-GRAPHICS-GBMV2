...
# Therefore all users should also be multithreaded
CWARNS           = -wx -we
CFLAGS           = $(CWARNS) -bt=nt -ze -zq -onatxhi -oe=100 -sg -ei -6r -fp6 -fpi87 -bm -mf -DNDEBUG -DWIN32 $(CJPEG) $(CJ2K) $(CJBIG) $(CPNG) $(CTIFF) $(CRAW)
CFLAGS_DBG       = $(CWARNS) -bt=nt -ze -zq -sg -ei -6r -fp6 -fpi87 -bm -mf -d2 -DDEBUG -DWIN32 $(CJPEG) $(CJ2K) $(CJBIG) $(CPNG) $(CTIFF) $(CRAW)
CFLAGS_EXE       = $(CFLAGS)
...
LFLAGS_EXE     = SYSTEM nt op stack=0x10000 $(LFLAGS)
LFLAGS_EXE_DBG = SYSTEM nt op stack=0x10000 $(LFLAGS_DBG)
LFLAGS_DLL     = sys nt_dll initi termi op caseexact $(LFLAGS)
LFLAGS_DLL_DBG = sys nt_dll initi termi op caseexact $(LFLAGS_DBG)
...
gbm.dll:  $(MAKEFILE_SRC2)\gbm.res gbm.obj gbmpbm.obj gbmpgm.obj gbmppm.obj gbmpnm.obj  \
          ...
          $(CL) $(LFLAGS_DLL) name $@ file gbm.obj,gbmpbm.obj,gbmpgm.obj,gbmppm.obj,\
...
gbmtool.lib:	gbmtool.obj gbmtwin.obj
                $(CLIB) $(LIBFLAGS) $@ +gbmtool.obj +gbmtwin.obj
...
gbmver.exe:	gbmverwin.obj
		$(CL) $(LFLAGS_EXE) name $@ file gbmverwin.obj
