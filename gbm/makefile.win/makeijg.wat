...
# the the Generalised Bitmap Module.
...
CFLAGS         = $(CWARNS) -bt=nt -zq -onatxh -oe=50 -sg -ei -6r -fp6 -fpi87 -bm -mf /DNDEBUG /DWIN32
CFLAGS_DBG     = $(CWARNS) -bt=nt -zq -sg -ei -6r -fp6 -fpi87 -bm -mf -d2 /DDEBUG /DWIN32
LIBFLAGS       = -q -n -b -c
...
jpeg.lib: $(LIBOBJECTS)
           wlib $(LIBFLAGS) $@ +jmemnobs.obj +jaricom.obj \
                            +jcomapi.obj  +jutils.obj   +jerror.obj   +jmemmgr.obj \
                            +jcapimin.obj +jcapistd.obj +jcarith.obj  +jctrans.obj  +jcparam.obj  +jdatadst.obj +jcinit.obj   +jcmaster.obj +jcmarker.obj +jcmainct.obj +jcprepct.obj +jccoefct.obj \
                            +jccolor.obj  +jcsample.obj +jchuff.obj   +jcdctmgr.obj +jfdctfst.obj +jfdctflt.obj +jfdctint.obj \
                            +jdapimin.obj +jdapistd.obj +jdarith.obj  +jdtrans.obj  +jdatasrc.obj +jdmaster.obj +jdinput.obj  +jdmarker.obj +jdhuff.obj   +jdmainct.obj +jdcoefct.obj \
                            +jdpostct.obj +jddctmgr.obj +jidctfst.obj +jidctflt.obj +jidctint.obj +jdsample.obj +jdcolor.obj  +jquant1.obj  +jquant2.obj  +jdmerge.obj
...
clean:
	 -del /F $(LIBOBJECTS) jmemgbm.obj 2>nul
	 -del /F /Q *.lst 2>nul

clobber:
	 -del /F $(LIBOBJECTS) jmemgbm.obj jpeg.lib 2>nul
	 -del /F jpeg.lib 2>nul
	 -del /F /Q *.lst $(IDIR)\* 2>nul
	 -del /F /Q $(IDIR)\* 2>nul
