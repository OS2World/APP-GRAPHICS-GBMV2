...
CFLAGS         = $(CWARNS) -ijpwl -bt=nt -ze -zq -onatxhl+ -oe=120 -sg -ei -6r -fp6 -fpi87 -bm -mf /DNDEBUG /DOPJ_STATIC /DUSE_JPWL /DWIN32
CFLAGS_DBG     = $(CWARNS) -ijpwl -bt=nt -ze -zq -sg -ei -6r -fp6 -fpi87 -bm -mf -d2 /DDEBUG /DOPJ_STATIC /DUSE_JPWL /DWIN32
LIBFLAGS       = -q -n -b -c
