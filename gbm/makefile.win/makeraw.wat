...
CWARNS         = -w1 -we
CFLAGS         = $(CWARNS) -i. -i.. -bt=nt -zq -onatxh -oe=50 -sg -ei -6r -fp6 -fpi87 -bm -mf -xs -xr -DWIN32 -DLIBRAW_NODLL -DNDEBUG
CFLAGS_DBG     = $(CWARNS) -i. -i.. -bt=nt -zq -sg -ei -6r -fp6 -fpi87 -bm -mf -xs -xr -d2 -DWIN32 -DLIBRAW_NODLL -DDEBUG
LIBFLAGS       = -q -n -b -c
